...
def main():
	if len(sys.argv) > 1:
		...
		urlToAnalyze = "http://www.francemusique.fr/emission/les-lundis-de-la-contemporaine/2014-2015/monographie-laurent-lefrancois-au-studio-106-de-la-maison-de-la-radio-01-19"
